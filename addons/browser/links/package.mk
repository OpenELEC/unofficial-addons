...
PKG_DEPENDS_TARGET="toolchain libressl libjpeg-turbo libpng libX11 libxcb libXau zlib:target"
...
PKG_CONFIGURE_OPTS_TARGET="--x-includes=$SYSROOT_PREFIX/usr/include/X11/ --x-libraries=$SYSROOT_PREFIX/usr/X11/lib/ --enable-graphics --with-ssl --disable-ssl-pkgconfig --without-bzip2 --without-bzlib --without-lzma --without-svgalib --with-x --without-directfb --without-libtiff"
