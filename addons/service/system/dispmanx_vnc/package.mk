...
addon() {
  ...
  mkdir -p $ROOT/$ADDON_BUILD/$PKG_ADDON_ID/lib
    find `get_build_dir libvncserver`/.$TARGET_NAME -iname libvncserver.so\* -exec cp -P {} $ROOT/$ADDON_BUILD/$PKG_ADDON_ID/lib \;
    find `get_build_dir libjpeg-turbo`/.$TARGET_NAME -iname libjpeg.so\* -exec cp -P {} $ROOT/$ADDON_BUILD/$PKG_ADDON_ID/lib \;
